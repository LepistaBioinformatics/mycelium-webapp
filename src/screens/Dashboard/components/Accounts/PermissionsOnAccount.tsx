  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      {filteredTenantsOwnership && filteredTenantsOwnership?.length > 0 && (
        <div
          className="flex items-center gap-3 rounded-lg border-2 border-dashed border-brand-violet-500 dark:border-brand-violet-500 px-3 py-1"
          title={t(
      ...
      {filteredLicensedResources
        ...
        ?.map((resource, index) => (
          <div
            key={index}
            className="flex items-center gap-3 rounded-lg border border-brand-violet-500 dark:border-brand-violet-500 pl-3 pr-1 py-1 group"
          >
