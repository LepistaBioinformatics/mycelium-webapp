        ...
        <div className="flex flex-col gap-8">
          {brandTag && (
            <div className="flex justify-center gap-2">
              ...
              <MdEdit
                className="cursor-pointer h-8 w-8 text-brand-violet-500 text-2xl dark:text-brand-lime-400 hover:scale-150 transition-all duration-200 -ml-10 bg-white dark:bg-zinc-800 rounded-full p-1 border border-brand-violet-300 dark:border-brand-lime-700"
