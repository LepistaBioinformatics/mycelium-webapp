...
const styles = cva("w-full", {
  variants: {
    style: {
      or: "flex items-center justify-between py-2 text-brand-violet-700 dark:text-brand-violet-700",
      invisible: "border-0",
      smooth: "opacity-30",
      partial:
        "w-48 mx-auto border-0 bg-brand-violet-300 dark:bg-brand-violet-700",
    },
    thickness: {
      sm: "h-0.5",
      md: "h-1",
