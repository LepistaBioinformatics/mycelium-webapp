...
const containerStyles = cva("text-zinc-500 dark:text-zinc-50", {
  variants: {
    padding,
    margin,
    type: {
...
const boxStyles = cva("text-zinc-500 dark:text-zinc-50", {
  variants: {
    type: {
      highlight:
        "bg-zinc-100 dark:bg-zinc-800 shadow-md rounded-lg border-2 dark:border-brand-violet-900 p-4",
