  ...
  return (
    <div className={styles({ hidden, groupHidden, inline, size })}>
      <button
        ...
        className="text-zinc-500 hover:text-zinc-700 hover:dark:text-zinc-300 group-hover:text-brand-violet-500 dark:group-hover:text-brand-lime-400 group-hover/clip:text-brand-violet-500 dark:group-hover/clip:text-brand-lime-400 focus:outline-none focus:rounded-md focus:ring-2 focus:ring-brand-violet-500 dark:focus:ring-brand-lime-400 p-1 -mt-2 focus:animate-pulse rounded-md bg-transparent"
