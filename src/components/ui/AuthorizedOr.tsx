...
const styles = cva(
  "flex flex-col gap-4 w-full sm:max-w-4xl mx-auto rounded-lg border px-4 py-2",
  {
    variants: {
      event: {
        loading: "border-brand-violet-300 dark:border-brand-violet-700",
...
export interface AuthorizedOrProps
  extends BaseProps,
