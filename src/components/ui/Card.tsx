...
const cardContainerStyles = cva("border border-blue-200 dark:border-indigo-900 shadow rounded-lg text-gray-500 bg-white dark:bg-slate-800 overflow-auto scrollbar h-min", {
  variants: {
    ...
    margin,
    maxHeight: {
      "90vh": "max-h-[90vh] xl:max-h-[50vh]",
      "80vh": "max-h-[80vh] xl:max-h-[50vh]",
      "70vh": "max-h-[70vh] xl:max-h-[50vh]",
      "60vh": "max-h-[60vh] xl:max-h-[50vh]",
    ...
    minHeight: {
      "90vh": "min-h-[90vh] xl:min-h-[50vh]",
      "80vh": "min-h-[80vh] xl:min-h-[50vh]",
      "70vh": "min-h-[70vh] xl:min-h-[50vh]",
      "60vh": "min-h-[60vh] xl:min-h-[50vh]",
