    ...
    <aside className={containerStyles({ open: isOpen })} {...props}>
      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <div className="flex justify-center items-center w-full text-center rounded-full p-2 hover:bg-blue-200 dark:hover:bg-slate-600">
          <Tooltip content="Toggle theme" className="px-2 border-2 border-white dark:border-lime-500 text-blue-800 dark:text-lime-500">
            <ThemeSwitcher />
          </Tooltip>
        </div>

        <button onClick={toggle} className="flex justify-center items-center w-full text-center bg-blue-50 dark:bg-slate-700 hover:bg-blue-200 dark:hover:bg-slate-600 rounded-full p-2">
          <Tooltip content="Toggle sidebar" className="px-2 border-2 border-white dark:border-lime-500 text-blue-800 dark:text-lime-500">
        ...
        <button onClick={logout} className="flex justify-center items-center w-full text-center bg-blue-50 dark:bg-slate-700 hover:bg-blue-200 dark:hover:bg-slate-600 rounded-full p-2">
          <Tooltip content="Logout" className="px-2 border-2 border-white dark:border-lime-500 text-blue-800 dark:text-lime-500">
