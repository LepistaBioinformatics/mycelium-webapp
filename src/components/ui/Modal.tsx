...
const containerStyles = cva("text-gray-500 dark:text-gray-50 fixed inset-0 z-50 flex flex-col justify-center items-center bg-opacity-50 bg-black", {
  variants: {
    open: {
      true: "block",
      false: "hidden",
...
const bodyStyles = cva("text-gray-500 dark:text-gray-50 flex justify-between items-center min-w-96 min-h-24", {
  variants: {},
});
