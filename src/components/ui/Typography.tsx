...
const styles = cva("whitespace-normal", {
  variants: {
    ...
    as: {
      ...
      title: "font-display !text-5xl text-zinc-600 dark:text-zinc-300 font-bold",
      h1: "font-display !text-3xl text-zinc-600 dark:text-zinc-300 font-bold",
      h2: "font-display !text-2xl text-zinc-600 dark:text-zinc-300 font-bold",
      h3: "font-display !text-xl text-zinc-600 dark:text-zinc-300 font-bold",
