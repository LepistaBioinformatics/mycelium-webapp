...
const summaryStyles = cva("cursor-pointer border border border-transparent dark:hover:border-indigo-700 hover:border-dashed px-2 py-1 bg-blue-50 dark:bg-slate-800 rounded-lg text-slate-500 dark:text-slate-200 bg-opacity-50 dark:bg-opacity-30", {
  variants: {
    marginTop: {
      false: "mt-0",
      "2": "mt-2",
